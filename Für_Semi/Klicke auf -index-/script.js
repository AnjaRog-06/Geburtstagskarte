document.addEventListener('DOMContentLoaded', function() {
    ...
    const textLightMode = "Ich wünsche dir unzählige Zombies in <span class=\"diamond-highlight\">Diamantrüstung</span>…";
    const textDarkMode = "Ich wünsche dir unzählige Zombies in <span class=\"diamond-highlight\">Diamantrüstung</span>…<br><br>… und alle <span class=\"stars-highlight\">Sternschnuppen</span> dieser Welt.";
    ...
    btnPlayPause.addEventListener('click', function() {
        ...
        if (isAnimationPaused) {
            ...
            btnPlayPause.title = 'Animation fortsetzen';
        } else {
            scene.classList.remove('paused');
            playPauseIcon.textContent = '⏸️';
            btnPlayPause.title = 'Animation pausieren';
        }
    });
